...
Rectangle {
    radius: 8; color: Qt.alpha(Theme.bgCard, 0.5); border { width: 1; color: Qt.alpha(Theme.accentBlue, 0.3) }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Item { width: 6 }
            Label { text: "Port Scan"; font.family: "JetBrains Mono"; font.pixelSize: 11; font.weight: Font.DemiBold; color: Theme.accentBlue }
        }
        ...
        RowLayout {
            ...
            Item { width: 6 }
            Label { text: "Scan Common Ports"; font.family: "JetBrains Mono"; font.pixelSize: 11; color: Theme.textPrimary }
        }
        ...
        RowLayout {
            ...
            Item { width: 4 }
            Label { text: "Range:"; font.family: "JetBrains Mono"; font.pixelSize: 11; color: Theme.textSecondary }
        }
        ...
        RowLayout {
            TextField {
                ...
                background: Rectangle { radius: 4; color: "transparent"; border { width: 1; color: fromField.focus ? Theme.cyan : "#3A3A5A" } }
                onTextChanged: { var v = parseInt(text)||0; v = Math.max(0, Math.min(65535, v)); appState.portScanFrom = v }
            }
            Item { width: 8 }
            Label { text: "–"; font.pixelSize: 13; color: Theme.textSecondary }
            Item { width: 8 }
            TextField {
                ...
                placeholderTextColor: Theme.textSecondary
                enabled: appState.runStatus !== 1
                background: Rectangle { radius: 4; color: "transparent"; border { width: 1; color: toField.focus ? Theme.cyan : "#3A3A5A" } }
        ...
        Label {
            ...
            text: "From Must Be ≤ To"; font.family: "JetBrains Mono"; font.pixelSize: 11; color: Theme.failRed
        }
    }
}
